...
The Accepted Payment Methods plugin is a straightforward, lightweight solution crafted to enhance your website by displaying visually appealing icons of the payment methods you accept.
...
**Features**
1. Supports svg, jpg, png, webp and other image format.
...
You can add unlimited icons unless it affects you design.
...
You can adjust the size of the icon. The shape depends upon you uploaded file.
...
The plugins is developed to work with all the major themes and tested, but we cannot guarantee due to the diversity and different working methods of the developers.

== Screenshots ==
1. [https://tinyurl.com/272atjyx] Main plugin dashboard.
2. [https://tinyurl.com/24hslzok] Settings page.
3. [https://tinyurl.com/2yf597cj] Documentation page.
4. [https://tinyurl.com/2y7rxdb9] Adding shortcode.
5. [https://tinyurl.com/23yhl8g2] Frontend Display.
